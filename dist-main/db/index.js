...
exports.schema = {
    ...
    `);
        ...
        const addColumn = (table, column, type) => {
            try {
                connection_1.default.prepare(`ALTER TABLE ${table} ADD COLUMN ${column} ${type}`).run();
        ...
        const beInfo = connection_1.default.prepare(`SELECT sql FROM sqlite_master WHERE type='table' AND name='blackboard_events'`).get();
