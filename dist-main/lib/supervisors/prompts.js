 ...
 */
function assembleSystemPrompt(base) {
    let memoryContext = '';
    try {
        memoryContext = (0, loader_1.getAuraMemory)().combinedSystemContext ?? '';
    }
    catch {
...
exports.DOMAIN_CONFIG = {
    research: {
        ...
        systemHint: 'Focus on retrieving verifiable facts, market signals, and synthesising them into actionable intelligence. ' +
    ...
    code: {
        ...
        systemHint: 'Focus on producing correct, runnable code. ' +
    ...
    planning: {
        ...
        systemHint: 'Focus on breaking objectives into concrete, prioritised steps. ' +
...
function buildSupervisorPrompt(config, objective, context) {
