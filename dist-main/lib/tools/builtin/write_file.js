...
exports.writeFileFn = exports.writeFileDef = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const PROJECT_ROOT = process.cwd();
exports.writeFileDef = {
    type: 'function',
    function: {
        name: 'write_file',
        description: 'Write content to a file in the project, creating it (and any parent directories) if needed. ' +
